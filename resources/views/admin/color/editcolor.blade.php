                ...
                <div class="col-md-6">
                    <div class="card shadow-lg border-0 rounded-4">
                        ...
                        <div class="card-body p-5">
                            ...
                            <!-- Form Start -->
                            <form method="POST" action="{{ route('update.color',$color->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div>
                                        ...
                                        <div class="col-md-9 mb-4 " >
                                            <input class="input-f form-control" type="text" name="color" placeholder="color name" value="{{$color->color}}">
